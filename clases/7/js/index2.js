function armarObjetos(items){
	return {name:items[1],value:0};
...
function armarArrayObjetos(){
var terremotos=[ '2015-05-04T18:04:54.320Z, South Georgia and the South Sandwich Islands,5.4,mb,,54,5.654,1.03,us,us20002b8y,2015-05-04T18:23:43.605Z,"21km NNW of Visokoi Island, South Georgia and the South Sandwich Islands",earthquake',
...
/obtengo el array de objetos/

	var item=[];
	var paises= [];
	var obj=armarObjetos(terremotos[0]);
	paises[0]=obj;

	for (var i = 0; i < terremotos.length; i++) {
		item=terremotos[i].split(",");
		
		var obj=armarObjetos(terremotos[i]);
			if()

			

					paises.push(armarObjetos(terremotos[i]));					
...
console.log(armarArrayObjetos());

//filter de array 
//funcion dada un array devuelve el indice
